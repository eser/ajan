...
func TestMustGetValue_PanicWithProvider(t *testing.T) {
	...
	require.ErrorIs(t, err, assert.AnError, "RegisterFn should return the provider error")
...
func TestInvoke_MissingDependency(t *testing.T) {
	...
	require.PanicsWithValue(t,
		...
		func() {
			di.DynamicInvoke(c, func(multiplier Multiplier) error { //nolint:errcheck,gosec
...
func TestInvoke_NonFunction(t *testing.T) {
	...
	require.PanicsWithValue(t,
		...
		func() {
			...
			di.DynamicInvoke(c, 42) //nolint:errcheck,gosec
		},
